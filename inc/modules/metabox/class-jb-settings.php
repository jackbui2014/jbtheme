    ...
    abstract class JB_Settings{
        ...
        */
        ...
        public function render_select( $field ) {
            extract( $field );
            if( !empty($object_type) && $object_type == 'post' && !empty($default)){            
                if( is_array($default) ){                
            ...
            <tr>
                ...
                <td>
                    <select name="<?php echo $name; ?>" id="<?php echo $name; ?>" class="<?php echo $classes; ?>" >
                        <?php 
            ...
            <?php
                ...
                <td>                
                    <select name="<?php echo $name; ?>[]" id="<?php echo $name; ?>" class="<?php echo $classes; ?>" multiple>
                        <?php 
                            foreach ($options as $value => $text) {
                                $selected = '';                                    
