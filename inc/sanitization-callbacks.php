 ...
 */
function jb_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function jb_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function jb_sanitize_email( $email, $setting ) {
 ...
 */
function jb_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function jb_sanitize_html( $html ) {
 ...
 */
function jb_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function jb_sanitize_nohtml( $nohtml ) {
 ...
 */
function jb_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function jb_sanitize_number_range( $number, $setting ) {
 ...
 */
function jb_sanitize_select( $input, $setting ) {
 ...
 */
function jb_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

if ( ! function_exists( 'jb_sanitize_scripts' ) ) {
	/**
	 *
	 ...
	 */
	function jb_sanitize_scripts( $s = '' ) {
		return wp_kses(
			$s,
			array(
				'script' => array(
