				...
				<div className="inner jb-contact-inner container">
					<div className="jb-contact-left animate__animated fadeInLeft" data-scroll>
						<div className="inner">
							...
							<p><i class="fas fa-phone-square"></i><span className="jb-contact-label">{__('Phone:', 'jbapp') } </span><a href={"tel:"+props.attributes.phone} className="jb-contact-content">{props.attributes.phone}</a> </p>
							)}
							{ props.attributes.email && (
							<p><i class="fas fa-envelope"></i><span className="jb-contact-label">{__('Email:', 'jbapp') } </span><a href={"mailto:"+props.attributes.email} className="jb-contact-content">{props.attributes.email}</a></p>
							)}
							{ props.attributes.address && (
							<p><i class="fas fa-map-marker-alt"></i><span className="jb-contact-label">{__('Address:', 'jbapp') } </span><span className="jb-contact-content">{props.attributes.address} </span></p>
							)}
